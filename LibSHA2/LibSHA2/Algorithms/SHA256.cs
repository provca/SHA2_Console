...
{
    /// <summary>
    /// Represents the SHA-256 hash algorithm, which is a member of the SHA-2 family.
    /// Implements the <see cref="IHashAlgorithm"/> interface.
    /// </summary>
    internal class SHA256 : SHA2Base<uint>, IHashAlgorithm
    {
        /// <summary>
        /// Gets the block size in bits for the SHA-256 algorithm.
        /// </summary>
        protected override int BlockSize => 512;

        /// <summary>
        /// Gets the hash size in bytes for the SHA-256 algorithm.
        /// </summary>
        protected override int HashSize => 8;

        /// <summary>
        /// Gets the number of rounds for the SHA-256 algorithm.
        /// </summary>
        protected override int Rounds => 64;

        /// <summary>
        /// Initializes the hash values used in the SHA-256 algorithm.
        /// These initial hash values are derived from the fractional parts of the square roots of the first eight prime numbers.
        /// The values used are:
        /// 0x6a09e667 (from the square root of 2),
        /// 0xbb67ae85 (from the square root of 3),
        /// 0x3c6ef372 (from the square root of 5),
        /// 0xa54ff53a (from the square root of 7),
        /// 0x510e527f (from the square root of 11),
        /// 0x9b05688c (from the square root of 13),
        /// 0x1f83d9ab (from the square root of 17),
        /// 0x5be0cd19 (from the square root of 19).
        /// </summary>
        ...
        /// <summary>
        /// Provides the round constants used in the SHA-256 algorithm.
